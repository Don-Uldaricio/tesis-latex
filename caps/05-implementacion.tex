...
\begin{itemize}
    ...
    \item Simulación: el simulador codifica cada muestra de entrada en trenes de espigas, ejecuta la red paso a paso durante una ventana temporal fija y decodifica la salida mediante \textit{Rate argmax}.
