...
\hline
\texttt{architecture} & Arquitectura & Categórico & Selecciona la combinación de codificador de entrada y decodificador de salida (Poisson o TTFS con decodificación \textit{Rate argmax}). \\
\hline
